...
enum MoteTypography {
    static let windowHeading = Font.system(size: 22, weight: .semibold)
    static let deviceName = Font.system(size: 22, weight: .semibold)
    static let sectionHeading = Font.system(size: 13)
